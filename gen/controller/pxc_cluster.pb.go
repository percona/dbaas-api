...
const (
	...
	// PXC_CLUSTER_STATE_CHANGING represents a cluster being changed (initializing).
	PXCClusterState_PXC_CLUSTER_STATE_CHANGING PXCClusterState = 1
	// PXC_CLUSTER_STATE_READY represents a cluster without pending changes (ready).
	PXCClusterState_PXC_CLUSTER_STATE_READY PXCClusterState = 2
	// PXC_CLUSTER_STATE_FAILED represents a failed cluster (error).
	...
	// PXC_CLUSTER_STATE_PAUSED represents a paused cluster state.
	PXCClusterState_PXC_CLUSTER_STATE_PAUSED PXCClusterState = 5
	// PXC_CLUSTER_STATE_UPGRADING represents cluster state that is undergoing an upgrade.
...
func (PXCBackupState) Descriptor() protoreflect.EnumDescriptor {
	return file_controller_pxc_cluster_proto_enumTypes[1].Descriptor()
}

func (PXCBackupState) Type() protoreflect.EnumType {
	return &file_controller_pxc_cluster_proto_enumTypes[1]
}
...
var file_controller_pxc_cluster_proto_rawDesc = []byte{
	...
	,
...
var file_controller_pxc_cluster_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
var file_controller_pxc_cluster_proto_goTypes = []interface{}{
	(PXCClusterState)(0),              // 0: percona.platform.dbaas.controller.v1beta1.PXCClusterState
	(PXCBackupState)(0),               // 1: percona.platform.dbaas.controller.v1beta1.PXCBackupState
	(*PXCClusterParams)(nil),          // 2: percona.platform.dbaas.controller.v1beta1.PXCClusterParams
...
var file_controller_pxc_cluster_proto_depIdxs = []int32{
	...
	7, // 3: percona.platform.dbaas.controller.v1beta1.PXCClusterParams.PXC.compute_resources:type_name -> percona.platform.dbaas.controller.v1beta1.ComputeResources
	7, // 4: percona.platform.dbaas.controller.v1beta1.PXCClusterParams.ProxySQL.compute_resources:type_name -> percona.platform.dbaas.controller.v1beta1.ComputeResources
	7, // 5: percona.platform.dbaas.controller.v1beta1.PXCClusterParams.HAProxy.compute_resources:type_name -> percona.platform.dbaas.controller.v1beta1.ComputeResources
