...
type PSMDBClusterParams struct {
	...
	// Expose ports to the world.
	Expose bool `protobuf:"varint,3,opt,name=expose,proto3" json:"expose,omitempty"`
	// Expose Type: ClusterIP, NodePort, LoadBalancer.
	// See https://www.percona.com/doc/kubernetes-operator-for-psmongodb/expose.html.
	ExposeType string `protobuf:"bytes,4,opt,name=expose_type,json=exposeType,proto3" json:"expose_type,omitempty"`
	// Port number to expose.
	ExposePort int32 `protobuf:"varint,5,opt,name=expose_port,json=exposePort,proto3" json:"expose_port,omitempty"`
}
...
func (x *PSMDBClusterParams) GetExposeType() string {
	if x != nil {
		return x.ExposeType
	}
	return ""
...
func (x *PSMDBClusterParams) GetExposePort() int32 {
	if x != nil {
		return x.ExposePort
	}
	return 0
...
var file_controller_psmdb_cluster_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa9, 0x03, 0x0a,
	...
	0x12, 0x16, 0x0a, 0x06, 0x65, 0x78, 0x70, 0x6f, 0x73, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x06, 0x65, 0x78, 0x70, 0x6f, 0x73, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x65, 0x78, 0x70, 0x6f,
	0x73, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x65,
	0x78, 0x70, 0x6f, 0x73, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x65, 0x78, 0x70,
	0x6f, 0x73, 0x65, 0x5f, 0x70, 0x6f, 0x72, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a,
	0x65, 0x78, 0x70, 0x6f, 0x73, 0x65, 0x50, 0x6f, 0x72, 0x74, 0x1a, 0x9b, 0x01, 0x0a, 0x0a, 0x52,
	...
	0x64, 0x69, 0x73, 0x6b, 0x53, 0x69, 0x7a, 0x65, 0x2a, 0xb7, 0x01, 0x0a, 0x11, 0x50, 0x53, 0x4d,
