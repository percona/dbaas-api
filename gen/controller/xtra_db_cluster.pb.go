...
type XtraDBClusterParams_ProxySQL struct {
	...
	// Disk size in bytes.
	DiskSize int64 `protobuf:"varint,2,opt,name=disk_size,json=diskSize,proto3" json:"disk_size,omitempty"`
	// Service type (to expose the servie).
...
func (x *XtraDBClusterParams_ProxySQL) GetServiceType() string {
	if x != nil {
...
var file_controller_xtra_db_cluster_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf1,
	...
	0x00, 0x52, 0x08, 0x64, 0x69, 0x73, 0x6b, 0x53, 0x69, 0x7a, 0x65, 0x1a, 0xc4, 0x01, 0x0a, 0x08,
	...
	0xdf, 0x1f, 0x02, 0x10, 0x00, 0x52, 0x08, 0x64, 0x69, 0x73, 0x6b, 0x53, 0x69, 0x7a, 0x65, 0x12,
	...
	0x70, 0x65, 0x2a, 0xc2, 0x01, 0x0a, 0x12, 0x58, 0x74, 0x72, 0x61, 0x44, 0x42, 0x43, 0x6c, 0x75,
