...
type ListPSMDBClustersRequest struct {
	...
	// provisioner is the service provisioner.
	//
	// Types that are assignable to Provisioner:
	//	*ListPSMDBClustersRequest_EksProvisioner
	Provisioner isListPSMDBClustersRequest_Provisioner `protobuf_oneof:"provisioner"`
}
...
func (m *ListPSMDBClustersRequest) GetProvisioner() isListPSMDBClustersRequest_Provisioner {
	if m != nil {
...
func (x *ListPSMDBClustersRequest) GetEksProvisioner() *EKSProvisioner {
	if x, ok := x.GetProvisioner().(*ListPSMDBClustersRequest_EksProvisioner); ok {
		return x.EksProvisioner
	}
	return nil
}

type isListPSMDBClustersRequest_Provisioner interface {
	isListPSMDBClustersRequest_Provisioner()
}

type ListPSMDBClustersRequest_EksProvisioner struct {
	// EKSProvisioner holds the necessary fields to connect to an EKS cluster.
	EksProvisioner *EKSProvisioner `protobuf:"bytes,1,opt,name=eks_provisioner,json=eksProvisioner,proto3,oneof"`
}

func (*ListPSMDBClustersRequest_EksProvisioner) isListPSMDBClustersRequest_Provisioner() {}
...
type GetPSMDBClusterCredentialsRequest struct {
	...
	//
	// Types that are assignable to Provisioner:
	//	*GetPSMDBClusterCredentialsRequest_EksProvisioner
	Provisioner isGetPSMDBClusterCredentialsRequest_Provisioner `protobuf_oneof:"provisioner"`
	// Cluster name.
...
func (m *GetPSMDBClusterCredentialsRequest) GetProvisioner() isGetPSMDBClusterCredentialsRequest_Provisioner {
	if m != nil {
		return m.Provisioner
	}
	return nil
...
func (x *GetPSMDBClusterCredentialsRequest) GetEksProvisioner() *EKSProvisioner {
	if x, ok := x.GetProvisioner().(*GetPSMDBClusterCredentialsRequest_EksProvisioner); ok {
		return x.EksProvisioner
	}
	return nil
}
...
type isGetPSMDBClusterCredentialsRequest_Provisioner interface {
	isGetPSMDBClusterCredentialsRequest_Provisioner()
}

type GetPSMDBClusterCredentialsRequest_EksProvisioner struct {
	// EKSProvisioner holds the necessary fields to connect to an EKS cluster.
	EksProvisioner *EKSProvisioner `protobuf:"bytes,1,opt,name=eks_provisioner,json=eksProvisioner,proto3,oneof"`
}

func (*GetPSMDBClusterCredentialsRequest_EksProvisioner) isGetPSMDBClusterCredentialsRequest_Provisioner() {
}
...
type CreatePSMDBClusterRequest struct {
	...
	//
	// Types that are assignable to Provisioner:
	//	*CreatePSMDBClusterRequest_EksProvisioner
	Provisioner isCreatePSMDBClusterRequest_Provisioner `protobuf_oneof:"provisioner"`
	// Cluster name.
	Name string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	// Cluster parameters.
...
func (m *CreatePSMDBClusterRequest) GetProvisioner() isCreatePSMDBClusterRequest_Provisioner {
	if m != nil {
		return m.Provisioner
	}
	return nil
...
func (x *CreatePSMDBClusterRequest) GetEksProvisioner() *EKSProvisioner {
	if x, ok := x.GetProvisioner().(*CreatePSMDBClusterRequest_EksProvisioner); ok {
		return x.EksProvisioner
	}
	return nil
}
...
type isCreatePSMDBClusterRequest_Provisioner interface {
	isCreatePSMDBClusterRequest_Provisioner()
}

type CreatePSMDBClusterRequest_EksProvisioner struct {
	// EKSProvisioner holds the necessary fields to connect to an EKS cluster.
	EksProvisioner *EKSProvisioner `protobuf:"bytes,1,opt,name=eks_provisioner,json=eksProvisioner,proto3,oneof"`
}

func (*CreatePSMDBClusterRequest_EksProvisioner) isCreatePSMDBClusterRequest_Provisioner() {}
...
type UpdatePSMDBClusterRequest struct {
	...
	//
	// Types that are assignable to Provisioner:
	//	*UpdatePSMDBClusterRequest_EksProvisioner
	Provisioner isUpdatePSMDBClusterRequest_Provisioner `protobuf_oneof:"provisioner"`
	// Cluster name.
	Name string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	// Cluster parameters.
...
func (m *UpdatePSMDBClusterRequest) GetProvisioner() isUpdatePSMDBClusterRequest_Provisioner {
	if m != nil {
		return m.Provisioner
	}
	return nil
...
func (x *UpdatePSMDBClusterRequest) GetEksProvisioner() *EKSProvisioner {
	if x, ok := x.GetProvisioner().(*UpdatePSMDBClusterRequest_EksProvisioner); ok {
		return x.EksProvisioner
	}
	return nil
}
...
type isUpdatePSMDBClusterRequest_Provisioner interface {
	isUpdatePSMDBClusterRequest_Provisioner()
}

type UpdatePSMDBClusterRequest_EksProvisioner struct {
	// EKSProvisioner holds the necessary fields to connect to an EKS cluster.
	EksProvisioner *EKSProvisioner `protobuf:"bytes,1,opt,name=eks_provisioner,json=eksProvisioner,proto3,oneof"`
}

func (*UpdatePSMDBClusterRequest_EksProvisioner) isUpdatePSMDBClusterRequest_Provisioner() {}
...
type DeletePSMDBClusterRequest struct {
	...
	//
	// Types that are assignable to Provisioner:
	//	*DeletePSMDBClusterRequest_EksProvisioner
	Provisioner isDeletePSMDBClusterRequest_Provisioner `protobuf_oneof:"provisioner"`
	// Cluster name.
	Name string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
}
...
func (m *DeletePSMDBClusterRequest) GetProvisioner() isDeletePSMDBClusterRequest_Provisioner {
	if m != nil {
		return m.Provisioner
	}
	return nil
...
func (x *DeletePSMDBClusterRequest) GetEksProvisioner() *EKSProvisioner {
	if x, ok := x.GetProvisioner().(*DeletePSMDBClusterRequest_EksProvisioner); ok {
		return x.EksProvisioner
	}
	return nil
}
...
type isDeletePSMDBClusterRequest_Provisioner interface {
	isDeletePSMDBClusterRequest_Provisioner()
}

type DeletePSMDBClusterRequest_EksProvisioner struct {
	// EKSProvisioner holds the necessary fields to connect to an EKS cluster.
	EksProvisioner *EKSProvisioner `protobuf:"bytes,1,opt,name=eks_provisioner,json=eksProvisioner,proto3,oneof"`
}

func (*DeletePSMDBClusterRequest_EksProvisioner) isDeletePSMDBClusterRequest_Provisioner() {}
...
type RestartPSMDBClusterRequest struct {
	...
	//
	// Types that are assignable to Provisioner:
	//	*RestartPSMDBClusterRequest_EksProvisioner
	Provisioner isRestartPSMDBClusterRequest_Provisioner `protobuf_oneof:"provisioner"`
	// Cluster name.
	Name string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
}
...
func (m *RestartPSMDBClusterRequest) GetProvisioner() isRestartPSMDBClusterRequest_Provisioner {
	if m != nil {
		return m.Provisioner
	}
	return nil
...
func (x *RestartPSMDBClusterRequest) GetEksProvisioner() *EKSProvisioner {
	if x, ok := x.GetProvisioner().(*RestartPSMDBClusterRequest_EksProvisioner); ok {
		return x.EksProvisioner
	}
	return nil
}
...
type isRestartPSMDBClusterRequest_Provisioner interface {
	isRestartPSMDBClusterRequest_Provisioner()
}

type RestartPSMDBClusterRequest_EksProvisioner struct {
	// EKSProvisioner holds the necessary fields to connect to an EKS cluster.
	EksProvisioner *EKSProvisioner `protobuf:"bytes,1,opt,name=eks_provisioner,json=eksProvisioner,proto3,oneof"`
}

func (*RestartPSMDBClusterRequest_EksProvisioner) isRestartPSMDBClusterRequest_Provisioner() {}
...
func (x *ListPSMDBClustersResponse_Cluster) GetState() DBClusterState {
	if x != nil {
		return x.State
	}
...
var file_controller_psmdb_cluster_api_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1d, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f,
	0x6c, 0x6c, 0x65, 0x72, 0x2f, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x65, 0x72,
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1e, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c,
	0x6c, 0x65, 0x72, 0x2f, 0x70, 0x73, 0x6d, 0x64, 0x62, 0x5f, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65,
	0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x36, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	...
	0x8f, 0x01, 0x0a, 0x18, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x53, 0x4d, 0x44, 0x42, 0x43, 0x6c, 0x75,
	0x73, 0x74, 0x65, 0x72, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x64, 0x0a, 0x0f,
	0x65, 0x6b, 0x73, 0x5f, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x65, 0x72, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x39, 0x2e, 0x70, 0x65, 0x72, 0x63, 0x6f, 0x6e, 0x61, 0x2e,
	...
	0x31, 0x2e, 0x45, 0x4b, 0x53, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x65, 0x72,
	0x48, 0x00, 0x52, 0x0e, 0x65, 0x6b, 0x73, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e,
	0x65, 0x72, 0x42, 0x0d, 0x0a, 0x0b, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x65,
	0x72, 0x22, 0xc2, 0x03, 0x0a, 0x19, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x53, 0x4d, 0x44, 0x42, 0x43,
	0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x68, 0x0a, 0x08, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x4c, 0x2e, 0x70, 0x65, 0x72, 0x63, 0x6f, 0x6e, 0x61, 0x2e, 0x70, 0x6c, 0x61, 0x74,
	...
	0x08, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x73, 0x1a, 0xba, 0x02, 0x0a, 0x07, 0x43, 0x6c,
	...
	0x74, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x39, 0x2e, 0x70, 0x65, 0x72, 0x63, 0x6f,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x55, 0x0a, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x3d, 0x2e, 0x70, 0x65, 0x72, 0x63, 0x6f, 0x6e, 0x61, 0x2e,
	0x70, 0x6c, 0x61, 0x74, 0x66, 0x6f, 0x72, 0x6d, 0x2e, 0x64, 0x62, 0x61, 0x61, 0x73, 0x2e, 0x63,
	0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61,
	...
	,
	...
	0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x50, 0x53, 0x4d, 0x44, 0x42, 0x43, 0x72, 0x65, 0x64, 0x65,
	0x6e, 0x74, 0x69, 0x61, 0x6c, 0x73, 0x52, 0x0b, 0x63, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69,
	0x61, 0x6c, 0x73, 0x22, 0xeb, 0x02, 0x0a, 0x19, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x50, 0x53,
	0x4d, 0x44, 0x42, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x12, 0x64, 0x0a, 0x0f, 0x65, 0x6b, 0x73, 0x5f, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69,
	0x6f, 0x6e, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x39, 0x2e, 0x70, 0x65, 0x72,
	...
	0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x45, 0x4b, 0x53, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x73,
	0x69, 0x6f, 0x6e, 0x65, 0x72, 0x48, 0x00, 0x52, 0x0e, 0x65, 0x6b, 0x73, 0x50, 0x72, 0x6f, 0x76,
	0x69, 0x73, 0x69, 0x6f, 0x6e, 0x65, 0x72, 0x12, 0x1a, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18,
	...
	0x6d, 0x73, 0x12, 0x46, 0x0a, 0x03, 0x70, 0x6d, 0x6d, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	,
	...
	0x61, 0x31, 0x2e, 0x45, 0x4b, 0x53, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x65,
	0x72, 0x48, 0x00, 0x52, 0x0e, 0x65, 0x6b, 0x73, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f,
	0x6e, 0x65, 0x72, 0x12, 0x1a, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x09, 0x42, 0x06, 0xe2, 0xdf, 0x1f, 0x02, 0x58, 0x01, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12,
	0x75, 0x0a, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x1a, 0x88, 0x03, 0x0a, 0x18, 0x55, 0x70, 0x64, 0x61, 0x74,
	...
	0x65, 0x72, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x88, 0x01, 0x0a, 0x0a, 0x72, 0x65, 0x70, 0x6c, 0x69,
	...
	0x63, 0x61, 0x53, 0x65, 0x74, 0x52, 0x0a, 0x72, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x73, 0x65,
	0x74, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x75, 0x73, 0x70, 0x65, 0x6e, 0x64, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x07, 0x73, 0x75, 0x73, 0x70, 0x65, 0x6e, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x72,
	0x65, 0x73, 0x75, 0x6d, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x72, 0x65, 0x73,
	0x75, 0x6d, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x18, 0x05, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x05, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x1a, 0x76, 0x0a, 0x0a, 0x52, 0x65, 0x70,
	...
	0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xac,
	0x01, 0x0a, 0x19, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x50, 0x53, 0x4d, 0x44, 0x42, 0x43, 0x6c,
	0x75, 0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x64, 0x0a, 0x0f,
	0x65, 0x6b, 0x73, 0x5f, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x65, 0x72, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x39, 0x2e, 0x70, 0x65, 0x72, 0x63, 0x6f, 0x6e, 0x61, 0x2e,
	0x70, 0x6c, 0x61, 0x74, 0x66, 0x6f, 0x72, 0x6d, 0x2e, 0x64, 0x62, 0x61, 0x61, 0x73, 0x2e, 0x63,
	0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61,
	...
	,
	...
	0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0xb9, 0x01, 0x0a, 0x1a, 0x47, 0x65, 0x74, 0x50, 0x53, 0x4d, 0x44, 0x42, 0x43, 0x6c, 0x75, 0x73,
	0x74, 0x65, 0x72, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x73, 0x12, 0x4c,
	...
	0x4d, 0x44, 0x42, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e,
	0x74, 0x69, 0x61, 0x6c, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x4d, 0x2e, 0x70,
	...
	0x61, 0x6c, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0xa1, 0x01, 0x0a, 0x12,
	...
	0xa1, 0x01, 0x0a, 0x12, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x53, 0x4d, 0x44, 0x42, 0x43,
	...
	0x6e, 0x73, 0x65, 0x12, 0xa1, 0x01, 0x0a, 0x12, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x50, 0x53,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0xa4, 0x01, 0x0a, 0x13, 0x52, 0x65, 0x73, 0x74,
...
var file_controller_psmdb_cluster_api_proto_goTypes = []interface{}{
	...
	(*EKSProvisioner)(nil),                                                // 15: percona.platform.dbaas.controller.v1beta1.EKSProvisioner
	...
	(DBClusterState)(0),                                                   // 19: percona.platform.dbaas.controller.v1beta1.DBClusterState
...
var file_controller_psmdb_cluster_api_proto_depIdxs = []int32{
	15, // 0: percona.platform.dbaas.controller.v1beta1.ListPSMDBClustersRequest.eks_provisioner:type_name -> percona.platform.dbaas.controller.v1beta1.EKSProvisioner
	...
	15, // 2: percona.platform.dbaas.controller.v1beta1.GetPSMDBClusterCredentialsRequest.eks_provisioner:type_name -> percona.platform.dbaas.controller.v1beta1.EKSProvisioner
	...
	15, // 4: percona.platform.dbaas.controller.v1beta1.CreatePSMDBClusterRequest.eks_provisioner:type_name -> percona.platform.dbaas.controller.v1beta1.EKSProvisioner
	...
	15, // 7: percona.platform.dbaas.controller.v1beta1.UpdatePSMDBClusterRequest.eks_provisioner:type_name -> percona.platform.dbaas.controller.v1beta1.EKSProvisioner
	...
	15, // 9: percona.platform.dbaas.controller.v1beta1.DeletePSMDBClusterRequest.eks_provisioner:type_name -> percona.platform.dbaas.controller.v1beta1.EKSProvisioner
	15, // 10: percona.platform.dbaas.controller.v1beta1.RestartPSMDBClusterRequest.eks_provisioner:type_name -> percona.platform.dbaas.controller.v1beta1.EKSProvisioner
	19, // 11: percona.platform.dbaas.controller.v1beta1.ListPSMDBClustersResponse.Cluster.state:type_name -> percona.platform.dbaas.controller.v1beta1.DBClusterState
...
func file_controller_psmdb_cluster_api_proto_init() {
	...
	file_controller_provisioners_proto_init()
	...
	file_controller_psmdb_cluster_api_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*ListPSMDBClustersRequest_EksProvisioner)(nil),
	}
	file_controller_psmdb_cluster_api_proto_msgTypes[2].OneofWrappers = []interface{}{
		(*GetPSMDBClusterCredentialsRequest_EksProvisioner)(nil),
	}
	file_controller_psmdb_cluster_api_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*CreatePSMDBClusterRequest_EksProvisioner)(nil),
	}
	file_controller_psmdb_cluster_api_proto_msgTypes[6].OneofWrappers = []interface{}{
		(*UpdatePSMDBClusterRequest_EksProvisioner)(nil),
	}
	file_controller_psmdb_cluster_api_proto_msgTypes[8].OneofWrappers = []interface{}{
		(*DeletePSMDBClusterRequest_EksProvisioner)(nil),
	}
	file_controller_psmdb_cluster_api_proto_msgTypes[10].OneofWrappers = []interface{}{
		(*RestartPSMDBClusterRequest_EksProvisioner)(nil),
	}
	type x struct{}
